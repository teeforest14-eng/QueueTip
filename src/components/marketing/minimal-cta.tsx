  ...
  if (variant === "primary") {
    return (
      <Link
        href={href}
        className={cn(
          "qt-cta-primary group is-primary inline-flex items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-base font-semibold tracking-tight text-neutral-950",
